    ...
    public class QuoteModel
    {
        ...
        public bool IsValidShippingAddress
        {
            get
            {
                return
                    (
                        !string.IsNullOrWhiteSpace(this.ShipToAddress1)
                        && !string.IsNullOrWhiteSpace(this.ShipToCity)
                        && !string.IsNullOrWhiteSpace(this.ShipToState)
                        && !string.IsNullOrWhiteSpace(this.ShipToZip)
                        && this.ShippingAndHandling > 0
                        && this.ShippingAndHandlingType != "Free"
                    ) ||
                    (
                        !string.IsNullOrWhiteSpace(this.ShipToAddress1)
                        && !string.IsNullOrWhiteSpace(this.ShipToCity)
        ...
        public bool IsQuantitySyncDisabled { get; set; }
        ...
        public string ApprovedDateFormated { get; set; }
        ...
        public string MailGunEvent { get; set; }
    }
}
