...
function MarkerClusterer(map, opt_markers, opt_options) {
  ...
  this.zoomOnClick_ = options['zoomOnClick'] || false;//true
  this.description_ = options['description'] || ' items: click to zoom';
  this.setupStyles_();
...
function Cluster(markerClusterer) {
  ...
  this.clusterIcon_ = new ClusterIcon(this, markerClusterer.getStyles(),
      markerClusterer.getGridSize(), markerClusterer.description_);
}
 ...
 * @ignore
 */
function ClusterIcon(cluster, styles, opt_padding, description) {
...
ClusterIcon.prototype.onAdd = function() {
  ...
  if (this.visible_) {
    ...
    // by alberto sarullo
    this.div_.setAttribute('title', this.sums_.text + this.description_);
  }
...
ClusterIcon.prototype.setSums = function(sums) {
  ...
  if (this.div_) {
	...
	// by Alberto Sarullo
    this.div_.setAttribute('title', sums.text + this.description_);
  }
...
MarkerClusterer.prototype['getCalculator'] =
    MarkerClusterer.prototype.getCalculator;
MarkerClusterer.prototype['getMarkerTitle'] =
    MarkerClusterer.prototype.getMarkerTitle;
