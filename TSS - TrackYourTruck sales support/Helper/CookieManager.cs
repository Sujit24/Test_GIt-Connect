...
namespace TSS.Helper
{
    public static class CookieManager
    {
        ...
        public static UserModel ReloadSessionFromCookie()
        {
            ...
            if (CookieManager.GetCookie("strTSSSessionId").ToString().Trim().Length > 0)
            {
                userModel.SessionId = Convert.ToInt32(CookieManager.GetCookie("strTSSSessionId"));
                userModel.EmployeeId = Convert.ToInt32(CookieManager.GetCookie("strTSSUserId"));
                userModel.ClientId = Convert.ToInt32(CookieManager.GetCookie("strTSSClientId"));
                userModel.EmployeeName = CookieManager.GetCookie("strTSSUsername");
                userModel.Login = CookieManager.GetCookie("strTSSLogin");
                userModel.EmployeeClientId = Convert.ToInt32(CookieManager.GetCookie("strTSSEmployeeClientId"));
                userModel.IsTSSAdmin = Convert.ToBoolean(CookieManager.GetCookie("strTSSIsTSSAdmin"));
                userModel.IsTSSUser = Convert.ToBoolean(CookieManager.GetCookie("strTSSIsTSSUser"));
                userModel.IsTSSQuoteApproval = Convert.ToBoolean(CookieManager.GetCookie("strTSSIsTSSQuoteApproval"));
            }
