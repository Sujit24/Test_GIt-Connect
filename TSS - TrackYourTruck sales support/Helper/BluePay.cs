...
namespace BluePayLibrary
{
    ...
    public class BluePay
    {
        ...
        private TytFacadeBiz tytFacadeBiz;
        private BluePayLogModel bluePayLog;
        ...
        public BluePay(string accountID, string secretKey, string mode)
        {
            ...
            tytFacadeBiz = new TytFacadeBiz();
            bluePayLog = new BluePayLogModel();
        }
        ...
        public void SetCustomerInformationV2(string name, string address1 = null, string address2 = null, string city = null, string state = null, string zip = null, string country = null, string phone = null, string email = null, string companyName = "")
        {
            this.name = name;
            this.addr1 = address1;
            this.addr2 = address2;
        ...
        public string Process()
        {
            ...
            switch (this.api)
            {
                ...
                case "bp10emu":
                    ...
                    "&TAMPER_PROOF_SEAL=" + HttpUtility.UrlEncode(this.TPS) +
                    "&NAME=" + HttpUtility.UrlEncode(this.name) +
            ...
            bluePayLog.QuoteId = string.IsNullOrWhiteSpace(this.orderID) ? 0 : int.Parse(this.orderID);
            bluePayLog.SubmittedUrl = this.URL + "?" + postData;

            //Create HTTPS POST object and send to BluePay
            ASCIIEncoding encoding = new ASCIIEncoding();
            // for localhost uncomment below 2 lines--- 9/23/2019
        ...
        public string ResponseParams(HttpWebResponse httpResponse)
        {
            ...
            bluePayLog.ReceivedUrl = response;
